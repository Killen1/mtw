...
<head>
    ...
    <link rel="stylesheet" href="<?php echo SITE_ROOT ?>dist/css/bootstrap-theme.min.css">
    <link rel="stylesheet" href="<?php echo SITE_ROOT ?>dist/css/bootstrap.min.css">
    ...
    <script src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-526da6b84c40c531"></script>
</head>
<body <?php body_class(); ?>>
<div id="width-wrapper"><!--#width-wrapper closes in Footer-->
    <div class="row">
        ...
        <div class="main-logo"><a href="<?php echo MTW_ROOT ?>" title="Maynard &amp; The Walnut"></a></div>
        <nav id="main-nav" class="navbar navbar-default col-sm-12 margin-0" role="navigation">
            ...
            <div class="col-sm-12">
                <div class="collapse navbar-collapse navbar-ex1-collapse" id="bs-collapse-1">
                    ...
                    ?>
                    <div class="social-media hidden-sm hidden-xs pull-right margin-top-15 text-right">
                        <ul class="header-nav addthis_toolbox addthis_32x32_style addthis_default_style padding-0 list-unstyled list-inline">
