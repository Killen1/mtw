    ...
    <div id="band-wrapper">
      <div class="row">
        <div class="col-xs-12 col-md-6 col-lg-4 margin-bottom-20">
          <h1 class="border-bottom">Band Members</h1>
          <div class="row">
            ...
            <?php if($bandpic->have_posts()) : ?>
              <?php while($bandpic->have_posts()): $bandpic->the_post(); ?>
                ...
                <div class="col-xs-6 col-sm-4 col-md-6 col-lg-6 col-xsp-12 margin-top-20">
                  <div class="member-photo">
                    <?php echo get_the_post_thumbnail( $post_id, array(150,150), array('alt' => 'Band Member') ); ?>
                    <div class="mouse-enter" style="display: none;">
                      <h3 class="wht margin-top-20 text-center font-size-21"><?php the_title(); ?></h3>
                    </div>  
                  </div>    
                </div>
              <?php endwhile;?>
        ...
        <div class="col-xs-12 col-md-6 col-lg-8">
          <h1 class="border-bottom">Biography</h1>
          <div class="band-bio">
